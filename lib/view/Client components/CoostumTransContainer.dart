// ignore_for_file: unnecessary_brace_in_string_interps, must_be_immutable, non_constant_identifier_names, prefer_typing_uninitialized_variables, file_names
        ...
        child: GestureDetector(
          onTap: () {
            Get.find<DetailsResult>()
                .selectedtrip(controller.tripsafterFilter[index]);
          },
          child: Container(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        CostumeAnimatedText(
                            color: Colors.white, text: Destination),
                      ],
                    ),
                    SizedBox(
                      height: Dimenssions.height10,
