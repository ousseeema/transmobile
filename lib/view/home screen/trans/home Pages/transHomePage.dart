...
import 'package:transmobile/view/Trans%20components/shimmer.dart';
import 'package:transmobile/view/home%20screen/trans/home%20Pages/addSinglePackage.dart';
                        ...
                        child: Column(
                          children: [
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  controller.Trip==null? Get.snackbar("Error", "You cant access this page for the moment", colorText: Colors.white, backgroundColor: Colors.red)
                                : 
                                 Get.to(()=> const AddSinglePackage());
                                },
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          controller.Trip==null? Get.snackbar("Error", "You must've alerady have a trip", backgroundColor: Colors.red, colorText: Colors.white): Get.to(()=>const UpdateTripScreen());
                        },
                        child: Text(
                          "Add/Edit",
                          style: TextStyle(
